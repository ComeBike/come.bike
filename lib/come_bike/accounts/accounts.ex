defmodule ComeBike.Accounts do
  @moduledoc """
  The boundary for the Accounts system.
  """

  import Ecto.{Query, Changeset}, warn: false
  alias ComeBike.{Accounts.User, Repo}
  ...
  def find_or_create_facebook_user(%{"id" => facebook_uid} = user) do
    case Repo.get_by(User, facebook_uid: facebook_uid) do
      %ComeBike.Accounts.User{} = user ->
        {:ok, user}

      _ ->
        create_facebook_user(user)
    end
  end

  def create_facebook_user(attrs) do
    %User{}
    |> User.create_facebook_changeset(attrs)
    |> Repo.insert()
  end
